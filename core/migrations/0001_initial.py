# Generated by Django 3.1 on 2021-09-18 16:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apartment_address', models.CharField(help_text='Where you stay', max_length=200)),
                ('country', django_countries.fields.CountryField(max_length=2)),
                ('zip', models.CharField(help_text='Zip e.g 00100', max_length=100)),
                ('address_type', models.CharField(choices=[('B', 'Billing'), ('S', 'Shipping')], max_length=1)),
                ('default', models.BooleanField(default=False)),
                ('user', models.ForeignKey(help_text='Attached user for this address', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('S', 'Shirt'), ('SW', 'Sport Wear'), ('OW', 'OutWear'), ('LP', 'Laptops'), ('SS', 'SmatScreens'), ('P', 'Phones'), ('E', 'Electronics')], max_length=2)),
